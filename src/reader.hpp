...
//
// Design guardrail: ALL access to file bytes goes through Reader (bounds-checked
// parsing of untrusted input is a core invariant). No code outside this file does
